...
var Switch = React70.forwardRef((props, ref) => (0, import_jsx_runtime66.jsx)(FormCheck_default, {
  ...props,
  ref,
  type: "switch"
}));
...
function useWaitForDOMRef(ref, onResolved) {
  const window2 = useWindow();
  const [resolvedRef, setRef] = (0, import_react35.useState)(() => resolveContainerRef(ref, window2 == null ? void 0 : window2.document));
  if (!resolvedRef) {
...
function NoopTransition({
  ...
  const hasEnteredRef = (0, import_react36.useRef)(inProp);
  ...
  const child = (0, import_react36.cloneElement)(children, {
    ref: combinedRef
  });
  if (inProp)
    return child;
...
function useTransition({
  ...
  const isInitialRef = (0, import_react37.useRef)(true);
...
function ImperativeTransition({
  ...
  const [exited, setExited] = (0, import_react37.useState)(!inProp);
  if (inProp && exited) {
    setExited(false);
  }
  ...
  const combinedRef = useMergedRefs_default(ref, children.ref);
  return exited && !inProp ? null : (0, import_react37.cloneElement)(children, {
    ref: combinedRef
  });
}
function renderTransition(Component2, runTransition, props) {
  if (Component2) {
    return (0, import_jsx_runtime76.jsx)(Component2, Object.assign({}, props));
  }
  if (runTransition) {
...
function useModalManager(provided) {
  ...
  const modal = (0, import_react38.useRef)({
    dialog: null,
    backdrop: null
  });
  return Object.assign(modal.current, {
    ...
    setDialogRef: (0, import_react38.useCallback)((ref) => {
      modal.current.dialog = ref;
    }, []),
    setBackdropRef: (0, import_react38.useCallback)((ref) => {
      modal.current.backdrop = ref;
    }, [])
  });
}
var Modal = (0, import_react38.forwardRef)((_ref, ref) => {
  let {
    show = false,
    role = "dialog",
    className,
  ...
  const [exited, setExited] = (0, import_react38.useState)(!show);
  const lastFocusRef = (0, import_react38.useRef)(null);
  (0, import_react38.useImperativeHandle)(ref, () => modal, [modal]);
  ...
  const removeFocusListenerRef = (0, import_react38.useRef)();
  const removeKeydownListenerRef = (0, import_react38.useRef)();
  ...
  return (0, import_jsx_runtime77.jsx)(import_jsx_runtime78.Fragment, {
    children: import_react_dom.default.createPortal((0, import_jsx_runtime79.jsxs)(import_jsx_runtime78.Fragment, {
...
var AbstractModalHeader = React86.forwardRef(({
  ...
  const context6 = (0, import_react39.useContext)(ModalContext_default);
...
var Modal2 = React89.forwardRef(({
  ...
  const renderBackdrop = (0, import_react40.useCallback)((backdropProps) => (0, import_jsx_runtime87.jsx)("div", {
    ...backdropProps,
...
function useMediaQuery(query, targetWindow = typeof window === "undefined" ? void 0 : window) {
  ...
  const [matches, setMatches] = (0, import_react44.useState)(() => mql ? mql.matches : false);
  useIsomorphicEffect_default(() => {
...
function createBreakpointHook(breakpointValues) {
  ...
  function useBreakpoint2(breakpointOrMap, direction, window2) {
    ...
    let query = (0, import_react45.useMemo)(() => Object.entries(breakpointMap).reduce((query2, [key, direction2]) => {
...
var Offcanvas = React100.forwardRef(({
  ...
  const modalManager = (0, import_react46.useRef)();
  bsPrefix = useBootstrapPrefix(bsPrefix, "offcanvas");
  const {
    onToggle
  } = (0, import_react46.useContext)(NavbarContext_default) || {};
  const [showOffcanvas, setShowOffcanvas] = (0, import_react46.useState)(false);
  ...
  const renderBackdrop = (0, import_react46.useCallback)((backdropProps) => (0, import_jsx_runtime98.jsx)("div", {
    ...backdropProps,
...
var Navbar = React103.forwardRef((props, ref) => {
  ...
  const handleCollapse = (0, import_react48.useCallback)((...args) => {
  ...
  const navbarContext = (0, import_react48.useMemo)(() => ({
...
var Overlay2 = React111.forwardRef(({
  ...
  const [firstRenderedState, setFirstRenderedState] = (0, import_react52.useState)(null);
...
var OverlayTrigger = ({
  ...
  return (0, import_jsx_runtime115.jsxs)(import_jsx_runtime114.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react53.cloneElement)(children, triggerProps), (0, import_jsx_runtime113.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
var ProgressBar = React117.forwardRef(({
  ...
  return (0, import_jsx_runtime121.jsx)("div", {
    ...
    children: children ? map(children, (child) => (0, import_react54.cloneElement)(child, {
      isChild: true
    })) : renderProgressBar({
      min: min2,
      now,
...
function useTabPanel(_ref) {
  ...
  const context6 = (0, import_react55.useContext)(TabContext_default);
  if (!context6)
...
var ToastFade = React130.forwardRef((props, ref) => (0, import_jsx_runtime136.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastHeader = React132.forwardRef(({
  ...
  const context6 = (0, import_react57.useContext)(ToastContext_default);
  const handleClick = useEventCallback((e) => {
...
var Toast = React134.forwardRef(({
  ...
  const delayRef = (0, import_react58.useRef)(delay);
  const onCloseRef = (0, import_react58.useRef)(onClose);
  ...
  const autohideFunc = (0, import_react58.useCallback)(() => {
    if (autohideToast) {
  ...
  const toastContext = (0, import_react58.useMemo)(() => ({
    onClose
  }), [onClose]);
  ...
  return (0, import_jsx_runtime140.jsx)(ToastContext_default.Provider, {
    value: toastContext,
    children: hasAnimation && Transition ? (0, import_jsx_runtime140.jsx)(Transition, {
      in: show,
      onEnter,
      onEntering,
      onEntered,
